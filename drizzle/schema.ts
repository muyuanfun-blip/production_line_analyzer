...
export const users = mysqlTable("users", {
  ...
  accessProfile: varchar("accessProfile", { length: 32 }).default("operator").notNull(),
...
export const userAccountAuditLogs = mysqlTable("user_account_audit_logs", {
  ...
  action: mysqlEnum("action", ["create", "reset_password", "set_active", "set_role", "set_permissions", "delete"]).notNull(),
