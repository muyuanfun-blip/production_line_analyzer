...
const sections: Section[] = [
  ...
  },
  {
    ...
    icon: <GitBranch className="w-5 h-5" />,
    title: "VSM 價值流程設計",
    subtitle: "以流程圖連結工序、流線與即時改善決策",
    color: "from-indigo-500/20 to-cyan-600/5",
    badge: "流程設計",
    steps: [
      { title: "建立流程圖與工序", desc: "從產線的「VSM 設計」進入，建立流程圖後新增供應商、工序、庫存、運輸與客戶節點。工序可對應既有工站，輸入 CT、人力與增值率。", tip: "優先讓每個主要工序對應正確工站，才能使用產品追蹤與監控聯動。" },
      { title: "建立流線與 KPI 覆蓋層", desc: "以流線連接工序，設定物料／資訊／看板類型、流量與搬運時間。畫布會呈現 CT、人力、增值率、總 CT、總人力與 Lead Time 等 KPI。" },
      { title: "使用版本時間軸與比較", desc: "每次保存流程後可在版本時間軸選取歷史版本，從兩個版本直接啟動比較，確認改善前後的工序與流程變動。" },
      { title: "匯出 PDF 報告", desc: "在匯出選單選擇「匯出 PDF 報告」，即可下載包含 KPI、瓶頸工序與工序明細的繁體中文報告；亦可使用 PNG、CSV 或 JSON 匯出。" },
      { title: "運用跨模組聯動", desc: "戰情監控可將即時瓶頸帶入 VSM；配置模擬可帶入情境 KPI；選取已對應工站的 VSM 工序，可直接前往產品追蹤查看流程紀錄。", tip: "遇到瓶頸時，建議先在 VSM 檢視流程設計，再從產品追蹤驗證實際等待與加工時間。" },
    ],
  },
  {
    id: "faq",
