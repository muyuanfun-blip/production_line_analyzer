...
export const sidebarNavigationGroups: SidebarNavGroup[] = [
  ...
  { key: "governance", label: "管理治理", adminOnly: true, items: [{ label: "使用者管理", path: "/admin/users" }, { label: "覆核品質儀表板", path: "/admin/action-review-quality" }, { label: "AI 審查治理", path: "/admin/ai-consensus-governance" }] },
];
